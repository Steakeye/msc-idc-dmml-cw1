...
cleansed_cophentic_coefficient <- cor.dendlist(d_list, "cophenetic")
```
```{r}
# Print correlation matrix
...
Using hierarchical clustering over this dataset has not proved very insightful, in fact less colrrelation was found between qualty and cluster than with the k-means method. Also, the size of the dataset and the complexity of agglomerative clustering, {\mathcal {O}}(n^{2}\log(n)) makes the method unsuitable for the oringal size of the dataset.
