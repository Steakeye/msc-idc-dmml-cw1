...
for (prop in wine.properties) {
  ...
  wine.scaled[prop]
  #wine.scaled[,prop]
  col <- wine.scaled_cleansed_bp_all[prop]
  outlier <- boxplot(col, plot=FALSE)$out
  indices <- outlier %in% col
  print("outlier")
  ...
  print(indices)
  #print(col)
  print(col %in% outlier)
  #wine.scaled_cleansed_bp_all <- wine.scaled_cleansed_bp_all[ !(wine.scaled_cleansed_bp_all[prop] == outlier) ]
  #wine.scaled_cleansed_bp_all <- wine.scaled_cleansed_bp_all[ !(col %in% outlier,]
}
