...
test_delta.nn1 <- output_delta_func(test_expected_data.nn1$`Expected Output`, test_expected_data.nn1$`Neural Net Output`)
...
//TODO: Get formulas for other indicators
- RMSE
- MAPE
